...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        ...
        Restaurant spyFunction = Mockito.spy(restaurant);
        Mockito.when(spyFunction.getCurrentTime()).thenReturn(LocalTime.parse("21:00:00"));

        assertTrue(spyFunction.isRestaurantOpen());
    }
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        //WRITE UNIT TEST CASE HERE
        Restaurant spyFunction = Mockito.spy(restaurant);
        Mockito.when(spyFunction.getCurrentTime()).thenReturn(LocalTime.parse("23:00:00"));

        assertFalse(spyFunction.isRestaurantOpen());
